...
import {n as t} from "./jsx-runtime-CHxL7yWb.js";
import {t as n} from "./preload-helper-rov5CBGT.js";
var r = e(t(), 1)
  , i = `popstate`;
function a(e) {
...
function m(e, t, n, r={}) {
    ...
    function v(e, t) {
        ...
        p = m();
        let i = u(r, p)
          , o = b.createHref(r.unstable_mask || r);
        c.replaceState(i, ``, o),
        s && f && f({
            action: l,
            location: b.location,
    ...
    let b = {
        ...
        listen(e) {
            ...
            return o.addEventListener(i, g),
            f = e,
            () => {
                o.removeEventListener(i, g),
                f = null
            }
        },
        createHref(e) {
...
function _(e, t, n, r) {
    let i = k((typeof t == `string` ? p(t) : t).pathname || `/`, n);
    if (i == null)
        return null;
    let a = y(e);
    x(a);
...
function y(e, t=[], n=[], r=``, i=!1) {
    let a = (e, a, o=i, c) => {
        ...
        if (l.relativePath.startsWith(`/`)) {
            if (!l.relativePath.startsWith(r) && o)
                return;
            s(l.relativePath.startsWith(r), `Absolute route path "${l.relativePath}" nested under path "${r}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),
            l.relativePath = l.relativePath.slice(r.length)
        }
        let u = j([r, l.relativePath])
          , d = n.concat(l);
        e.children && e.children.length > 0 && (s(e.index !== !0, `Index routes must not have child routes. Please remove all child routes from route path "${u}".`),
        y(e.children, t, d, u, o)),
...
function x(e) {
    e.sort( (e, t) => e.score === t.score ? D(e.routesMeta.map(e => e.childrenIndex), t.routesMeta.map(e => e.childrenIndex)) : t.score - e.score)
}
var S = /^:[\w-]+$/
  , C = 3
  , ee = 2
...
function ne(e, t) {
    let n = e.split(`/`)
      , r = n.length;
    return n.some(E) && (r += te),
    t && (r += ee),
    n.filter(e => !E(e)).reduce( (e, t) => e + (S.test(t) ? C : t === `` ? w : T), r)
}
function D(e, t) {
...
function re(e, t, n=!1) {
    ...
    for (let e = 0; e < r.length; ++e) {
        let s = r[e]
          ...
          , d = s.route;
        if (!u && c && n && !r[r.length - 1].route.index && (u = O({
            path: s.relativePath,
            caseSensitive: s.caseSensitive,
            end: !1
        }, l)),
        ...
        o.push({
            ...
            pathnameBase: fe(j([a, u.pathnameBase])),
            route: d
        }),
...
function se(e, t=`/`) {
    ...
    a = n.startsWith(`/`) ? ce(n.substring(1), `/`) : ce(n, t)) : a = t,
    {
        pathname: a,
        search: pe(r),
        hash: me(i)
...
function de(e, t, n, r=!1) {
    let i;
    typeof e == `string` ? i = p(e) : (i = {
        ...e
    },
    s(!i.pathname || !i.pathname.includes(`?`), A(`?`, `pathname`, `search`, i)),
    s(!i.pathname || !i.pathname.includes(`#`), A(`#`, `pathname`, `hash`, i)),
    s(!i.search || !i.search.includes(`#`), A(`#`, `search`, `hash`, i)));
...
var ve = typeof window < `u` && window.document !== void 0 && window.document.createElement !== void 0;
function ye(e, t) {
    let n = e;
    if (typeof n != `string` || !oe.test(n))
        return {
            absoluteURL: void 0,
            isExternal: !1,
            to: n
...
var Ee = `REACT_ROUTER_ERROR`
  , De = `REDIRECT`
  , Oe = `ROUTE_ERROR_RESPONSE`;
function ke(e) {
    if (e.startsWith(`${Ee}:${De}:{`))
        try {
...
function je(e, {relative: t}={}) {
    s(R(), `useHref() may be used only in the context of a <Router> component.`);
    let {basename: n, navigator: i} = r.useContext(P)
      , {hash: a, pathname: o, search: c} = B(e, {
        relative: t
    })
      , l = o;
    return n !== `/` && (l = o === `/` ? n : j([n, o])),
    i.createHref({
        pathname: l,
        search: c,
        hash: a
...
function R() {
    return r.useContext(F) != null
}
function z() {
    return s(R(), `useLocation() may be used only in the context of a <Router> component.`),
    r.useContext(F).location
}
function Me() {
    return r.useContext(F).navigationType
}
var Ne = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function Pe(e) {
    r.useContext(P).static || r.useLayoutEffect(e)
}
function Fe() {
    let {isDataRoute: e} = r.useContext(I);
    return e ? et() : Ie()
}
function Ie() {
    s(R(), `useNavigate() may be used only in the context of a <Router> component.`);
    let e = r.useContext(M)
      , {basename: t, navigator: n} = r.useContext(P)
      , {matches: i} = r.useContext(I)
      , {pathname: a} = z()
      , o = JSON.stringify(ue(i))
      , l = r.useRef(!1);
    return Pe( () => {
        l.current = !0
    }
    ...
    r.useCallback( (r, i={}) => {
        ...
        let s = de(r, JSON.parse(o), a, i.relative === `path`);
        e == null && t !== `/` && (s.pathname = s.pathname === `/` ? t : j([t, s.pathname])),
...
function Re(e) {
    ...
    return r.useMemo( () => t && r.createElement(Le.Provider, {
        value: e
    }, t), [t, e])
}
function ze() {
    let {matches: e} = r.useContext(I)
      , t = e[e.length - 1];
    return t ? t.params : {}
}
function B(e, {relative: t}={}) {
    let {matches: n} = r.useContext(I)
      , {pathname: i} = z()
      , a = JSON.stringify(ue(n));
    return r.useMemo( () => de(e, JSON.parse(a), i, t === `path`), [e, a, i, t])
}
function Be(e, t) {
    return Ve(e, t)
}
function Ve(e, t, n) {
    ...
    let {navigator: i} = r.useContext(P)
      , {matches: a} = r.useContext(I)
      , o = a[a.length - 1]
      , l = o ? o.params : {}
      , u = o ? o.pathname : `/`
      , d = o ? o.pathnameBase : `/`
    ...
    {
        let e = f && f.path || ``;
        nt(u, !f || e.endsWith(`*`) || e.endsWith(`*?`), `You rendered descendant <Routes> (or called \`useRoutes()\`) at "${u}" (under <Route path="${e}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${e}"> to <Route path="${e === `/` ? `*` : `${e}/*`}">.`)
    }
    let m = z(), h;
    if (t) {
        let e = typeof t == `string` ? p(t) : t;
        s(d === `/` || e.pathname?.startsWith(d), `When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${d}" but pathname "${e.pathname}" was given in the \`location\` prop.`),
        h = e
    } else
        h = m;
    let _ = h.pathname || `/`
    ...
    c(f || y != null, `No routes matched location "${h.pathname}${h.search}${h.hash}" `),
    c(y == null || y[y.length - 1].route.element !== void 0 || y[y.length - 1].route.Component !== void 0 || y[y.length - 1].route.lazy !== void 0, `Matched leaf route at location "${h.pathname}${h.search}${h.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);
    let b = qe(y && y.map(e => Object.assign({}, e, {
        params: Object.assign({}, l, e.params),
        pathname: j([d, i.encodeLocation ? i.encodeLocation(e.pathname.replace(/\?/g, `%3F`).replace(/#/g, `%23`)).pathname : e.pathname]),
        pathnameBase: e.pathnameBase === `/` ? d : j([d, i.encodeLocation ? i.encodeLocation(e.pathnameBase.replace(/\?/g, `%3F`).replace(/#/g, `%23`)).pathname : e.pathnameBase])
    })), a, n);
    return t && b ? r.createElement(F.Provider, {
        value: {
            location: {
                pathname: `/`,
                search: ``,
...
function He() {
    ...
    s = r.createElement(r.Fragment, null, r.createElement(`p`, null, `💿 Hey developer 👋`), r.createElement(`p`, null, `You can provide a way better UX than this when your app throws errors by providing your own `, r.createElement(`code`, {
        style: o
...
var Ue = r.createElement(He, null)
  , We = class extends r.Component {
    ...
    render() {
        ...
        let t = e === void 0 ? this.props.children : r.createElement(I.Provider, {
            value: this.props.routeContext
        }, r.createElement(L.Provider, {
            value: e,
            children: this.props.component
        }));
        return this.context ? r.createElement(Ge, {
            error: e
        }, t) : t
    }
}
...
We.contextType = Se;
var V = new WeakMap;
function Ge({children: e, error: t}) {
    let {basename: n} = r.useContext(P);
...
function Ke({routeContext: e, match: t, children: n}) {
...
function qe(e, t=[], n) {
    ...
    if (n && i) {
        ...
        for (let e = 0; e < a.length; e++) {
            let t = a[e];
            if ((t.route.HydrateFallback || t.route.hydrateFallbackElement) && (l = e),
            t.route.id) {
                let {loaderData: e, errors: r} = i
                  , o = t.route.loader && !e.hasOwnProperty(t.route.id) && (!r || r[t.route.id] === void 0);
                if (t.route.lazy || o) {
                    n.isStatic && (c = !0),
                    a = l >= 0 ? a.slice(0, l + 1) : [a[0]];
                    break
                }
            }
        }
    ...
    return a.reduceRight( (e, n, s) => {
        ...
        i && (u = o && n.route.id ? o[n.route.id] : void 0,
        p = n.route.errorElement || Ue,
        c && (l < 0 && s === 0 ? (nt(`route-fallback`, !1, "No `HydrateFallback` element provided to render during initial hydration"),
        f = !0,
        m = null) : l === s && (f = !0,
        ...
        let h = t.concat(a.slice(0, s + 1))
          , g = () => {
            let t;
            return t = u ? p : f ? m : n.route.Component ? r.createElement(n.route.Component, null) : n.route.element ? n.route.element : e,
            r.createElement(Ke, {
                match: n,
                routeContext: {
                    outlet: e,
        ...
        ;
        return i && (n.route.ErrorBoundary || n.route.errorElement || s === 0) ? r.createElement(We, {
            location: i.location,
...
function Qe() {
    let {matches: e, loaderData: t} = U(`useMatches`);
    return r.useMemo( () => e.map(e => v(e, t)), [e, t])
}
function $e() {
...
r.useOptimistic,
r.memo(rt);
function rt({routes: e, future: t, state: n, isStatic: r, onError: i}) {
    return Ve(e, void 0, {
        state: n,
        isStatic: r,
        onError: i,
...
function ot({basename: e=`/`, children: t=null, location: n, navigationType: i=`POP`, navigator: a, static: o=!1, unstable_useTransitions: l}) {
    ...
    let {pathname: f=`/`, search: m=``, hash: h=``, state: g=null, key: _=`default`, unstable_mask: v} = n
      , y = r.useMemo( () => {
        let e = k(f, u);
        return e == null ? null : {
            location: {
    ...
    , [u, f, m, h, g, _, i, v]);
    return c(y != null, `<Router basename="${u}"> is not able to match the URL "${f}${m}${h}" because it does not start with the basename, so the <Router> won't render anything.`),
    y == null ? null : r.createElement(P.Provider, {
        value: d
...
function st({children: e, location: t}) {
    return Be(G(e), t)
}
function G(e, t=[]) {
    let n = [];
    return r.Children.forEach(e, (e, i) => {
        ...
        s(e.type === at, `[${typeof e.type == `string` ? e.type : e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),
        ...
        e.props.children && (o.children = G(e.props.children, a)),
        n.push(o)
    }
    ),
    n
...
var ht = new Set([`application/x-www-form-urlencoded`, `multipart/form-data`, `text/plain`]);
function gt(e) {
    return e != null && !ht.has(e) ? (c(!1, `"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${q}"`),
    null) : e
}
function _t(e, t) {
    let n, r, i, a, o;
    if (lt(e)) {
        ...
        i = gt(e.getAttribute(`formenctype`)) || gt(o.getAttribute(`enctype`)) || q,
        a = new FormData(o,e),
        !mt()) {
...
function St(e, t, n, r) {
    ...
    return n ? i.pathname.endsWith(`/`) ? i.pathname = `${i.pathname}_.${r}` : i.pathname = `${i.pathname}.${r}` : i.pathname === `/` ? i.pathname = `_root.${r}` : t && k(i.pathname, t) === `/` ? i.pathname = `${t.replace(/\/$/, ``)}/_root.${r}` : i.pathname = `${i.pathname.replace(/\/$/, ``)}.${r}`,
    i
}
...
async function Et(e, t, n) {
    ...
    ))).flat(1).filter(Tt).filter(e => e.rel === `stylesheet` || e.rel === `preload`).map(e => e.rel === `stylesheet` ? {
        ...e,
        rel: `prefetch`,
        as: `style`
    } : {
...
function jt(e, t) {
    let n = new Set
      , r = new Set(t);
    return e.reduce( (e, i) => {
        if (t && !wt(i) && i.as === `script` && i.href && r.has(i.href))
            return e;
...
function Mt() {
    let e = r.useContext(M);
    return xt(e, `You must render this element inside a <DataRouterContext.Provider> element`),
    e
}
function Nt() {
    let e = r.useContext(N);
    return xt(e, `You must render this element inside a <DataRouterStateContext.Provider> element`),
    e
}
var Z = r.createContext(void 0);
Z.displayName = `FrameworkContext`;
function Pt() {
    let e = r.useContext(Z);
    return xt(e, `You must render this element inside a <HydratedRouter> element`),
    e
}
function Ft(e, t) {
...
function It({page: e, ...t}) {
    let {router: n} = Mt()
      , i = r.useMemo( () => g(n.routes, e, n.basename), [n.routes, e, n.basename]);
    return i ? r.createElement(Rt, {
        page: e,
        matches: i,
        ...t
    }) : null
...
function Rt({page: e, matches: t, ...n}) {
    ...
    , [c, a.unstable_trailingSlashAwareDataRequests, l, i, o, d, t, e, s])
      ...
      , h = Lt(f);
    return r.createElement(r.Fragment, null, p.map(e => r.createElement(`link`, {
        key: e,
        rel: `prefetch`,
        as: `fetch`,
        href: e,
        ...n
    })), m.map(e => r.createElement(`link`, {
        key: e,
        rel: `modulepreload`,
        href: e,
        ...n
    })), h.map( ({key: e, link: t}) => r.createElement(`link`, {
        key: e,
        nonce: n.nonce,
        ...t,
...
var Bt = typeof window < `u` && window.document !== void 0 && window.document.createElement !== void 0;
try {
    Bt && (window.__reactRouterVersion = `7.13.1`)
} catch {}
function Vt({basename: e, children: t, unstable_useTransitions: n, window: i}) {
    let a = r.useRef();
    a.current ??= o({
        window: i,
        v5Compat: !0
    ...
    let s = a.current
      ...
      , u = r.useCallback(e => {
        n === !1 ? l(e) : r.startTransition( () => l(e))
    }
    , [n]);
    return r.useLayoutEffect( () => s.listen(u), [s, u]),
    r.createElement(ot, {
        basename: e,
        children: t,
        location: c.location,
...
function Ht({basename: e, children: t, history: n, unstable_useTransitions: i}) {
    let[a,o] = r.useState({
        action: n.action,
        location: n.location
    })
      , s = r.useCallback(e => {
        i === !1 ? o(e) : r.startTransition( () => o(e))
    }
    , [i]);
    return r.useLayoutEffect( () => n.listen(s), [n, s]),
    r.createElement(ot, {
        basename: e,
        children: t,
        location: a.location,
...
Ht.displayName = `unstable_HistoryRouter`;
var Ut = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i
  , Wt = r.forwardRef(function({onClick: e, discover: t=`render`, prefetch: n=`none`, relative: i, reloadDocument: a, replace: o, unstable_mask: s, state: c, target: l, to: u, preventScrollReset: d, viewTransition: f, unstable_defaultShouldRevalidate: p, ...m}, h) {
    let {basename: g, navigator: _, unstable_useTransitions: v} = r.useContext(P)
      , y = typeof u == `string` && Ut.test(u)
      , b = ye(u, g);
    u = b.to;
    let x = je(u, {
        relative: i
      ...
      , C = null;
    if (s) {
        let e = de(s, [], S.unstable_mask ? S.unstable_mask.pathname : `/`, !0);
        g !== `/` && (e.pathname = e.pathname === `/` ? g : j([g, e.pathname])),
        C = _.createHref(e)
    }
    let[ee,w,T] = Ft(n, m)
      , te = Zt(u, {
    ...
    return ee && !y ? r.createElement(r.Fragment, null, D, r.createElement(It, {
        page: x
    })) : D
});
Wt.displayName = `Link`;
var Gt = r.forwardRef(function({"aria-current": e=`page`, caseSensitive: t=!1, className: n=``, end: i=!1, style: a, to: o, viewTransition: s, children: c, ...l}, u) {
    let d = B(o, {
        relative: l.relative
    })
      , f = z()
      , p = r.useContext(N)
      , {navigator: m, basename: h} = r.useContext(P)
      , g = p != null && cn(d) && s === !0
    ...
    w = typeof n == `function` ? n(C) : [n, x ? `active` : null, S ? `pending` : null, g ? `transitioning` : null].filter(Boolean).join(` `);
...
var Kt = r.forwardRef( ({discover: e=`render`, fetcherKey: t, navigate: n, reloadDocument: i, replace: a, state: o, method: s=K, action: c, onSubmit: l, relative: u, preventScrollReset: d, viewTransition: f, unstable_defaultShouldRevalidate: p, ...m}, h) => {
    let {unstable_useTransitions: g} = r.useContext(P)
      , _ = tn()
      , v = nn(c, {
        relative: u
    })
      , y = s.toLowerCase() === `get` ? `get` : `post`
      , b = typeof c == `string` && Ut.test(c);
...
Kt.displayName = `Form`;
function qt({getKey: e, storageKey: t, ...n}) {
    let i = r.useContext(Z)
      , {basename: a} = r.useContext(P)
      , o = z()
      , s = Qe();
    on({
        getKey: e,
    ...
    return r.createElement(`script`, {
        ...
        dangerouslySetInnerHTML: {
            __html: `(${l})(${bt(JSON.stringify(t || rn))}, ${bt(JSON.stringify(c))})`
        }
    })
}
qt.displayName = `ScrollRestoration`;
function Jt(e) {
    return `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`
}
function Yt(e) {
...
function Zt(e, {target: t, replace: n, unstable_mask: i, state: a, preventScrollReset: o, relative: s, viewTransition: c, unstable_defaultShouldRevalidate: l, unstable_useTransitions: u}={}) {
    let d = Fe()
      , p = z()
      , m = B(e, {
        relative: s
    });
    return r.useCallback(h => {
        if (ft(h, t)) {
            h.preventDefault();
            let t = n === void 0 ? f(p) === f(m) : n
              , g = () => d(e, {
                replace: t,
                unstable_mask: i,
                state: a,
...
function Qt(e) {
    ...
    let t = r.useRef(Y(e))
      ...
      , o = Fe();
    return [a, r.useCallback( (e, t) => {
        let r = Y(typeof e == `function` ? e(new URLSearchParams(a)) : e);
        n.current = !0,
        o(`?` + r, t)
    }
    , [o, a])]
...
var $t = 0
  , en = () => `__${String(++$t)}__`;
function tn() {
    let {router: e} = Yt(`useSubmit`)
      , {basename: t} = r.useContext(P)
      , n = Xe()
      , i = e.fetch
      , a = e.navigate;
    return r.useCallback(async (e, r={}) => {
        let {action: o, method: s, encType: c, formData: l, body: u} = _t(e, t);
        r.navigate === !1 ? await i(r.fetcherKey || en(), n, r.action || o, {
...
function an(e, t, n, r) {
    ...
    return r && (i = r(n === `/` ? e : {
        ...e,
        pathname: k(e.pathname, n) || e.pathname
    }, t)),
    i ??= e.key,
    i
}
function on({getKey: e, storageKey: t}={}) {
    let {router: n} = Yt(`useScrollRestoration`)
      , {restoreScrollPosition: i, preventScrollReset: a} = Xt(`useScrollRestoration`)
      , {basename: o} = r.useContext(P)
      , s = z()
      , l = Qe()
      , u = Ze();
    ...
    sn(r.useCallback( () => {
        ...
        try {
            sessionStorage.setItem(t || rn, JSON.stringify($))
        } catch (e) {
    ...
    , [u.state, e, o, s, l, t])),
    typeof document < `u` && (r.useLayoutEffect( () => {
        try {
    ...
    , [t]),
    r.useLayoutEffect( () => {
        let t = n?.enableScrollRestoration($, () => window.scrollY, e ? (t, n) => an(t, n, o, e) : void 0);
        return () => t && t()
    }
    , [n, o, e]),
    r.useLayoutEffect( () => {
...
function cn(e, {relative: t}={}) {
    ...
    let {basename: i} = Yt(`useViewTransitionState`)
      , a = B(e, {
        relative: t
    });
    if (!n.isTransitioning)
        return !1;
    let o = k(n.currentLocation.pathname, i) || n.currentLocation.pathname
      , c = k(n.nextLocation.pathname, i) || n.nextLocation.pathname;
    return O(a.pathname, c) != null || O(a.pathname, o) != null
}
export {st as a, z as c, Qt as d, at as i, Me as l, Wt as n, G as o, it as r, g as s, Vt as t, ze as u};
