...
import {n as t, t as n} from "./dist-XQ3aZ_cj.js";
var r = e((e => {
    n();
    var r = Symbol.for(`react.transitional.element`)
      ...
      , h = Symbol.iterator;
    function g(e) {
        return typeof e != `object` || !e ? null : (e = h && e[h] || e[`@@iterator`],
    ...
    function P(e) {
        ...
        case `rejected`:
            throw e.reason;
        default:
            switch (typeof e.status == `string` ? e.then(T, T) : (e.status = `pending`,
            e.then(function(t) {
    ...
    function F(e, t, n, a, o) {
        ...
        if (c)
            ...
            c = a === `` ? `.` + N(e, 0) : a,
            w(o) ? (n = ``,
            c != null && (n = c.replace(M, `$&/`) + `/`),
            F(o, t, n, ``, function(e) {
                return e
            })) : o != null && (A(o) && (o = k(o, n + (o.key == null || e && e.key === o.key ? `` : (`` + o.key).replace(M, `$&/`) + `/`) + c)),
            t.push(o)),
            1;
        c = 0;
        var l = a === `` ? `.` : a + `:`;
    ...
    e.cloneElement = function(e, t, n) {
        ...
        if (t != null)
            ...
            t)
                !D.call(t, a) || a === `key` || a === `__self` || a === `__source` || a === `ref` && t.ref === void 0 || (r[a] = t[a]);
    ...
    e.createElement = function(e, t, n) {
        ...
        if (t != null)
            ...
            t)
                D.call(t, r) && r !== `key` && r !== `__self` && r !== `__source` && (i[r] = t[r]);
    ...
    e.startTransition = function(e) {
        ...
        try {
            var r = e()
              , i = E.S;
            i !== null && i(n, r),
            typeof r == `object` && r && typeof r.then == `function` && r.then(T, R)
        } catch (e) {
            R(e)
        } finally {
